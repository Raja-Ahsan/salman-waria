...
@section('meta_title', 'WORLD IN 2050 | New Book by Salman Waria')
@section('meta_description', 'Discover the world in 2050 book by Salman Waria. Explore if AI will rule the world by 2050 in this Amazon bestseller tracking future technology trajectories.')
@section('meta_keywords', 'WORLD IN 2050')
@section('canonical_url', route('book'))
...
<div class="book-page-video">
<video src="{{ asset('video/World-in-2050.mp4') }}" autoplay muted loop playsinline preload="metadata" aria-hidden="true"></video>
</div>
      <!-- ── PAGE HERO ─────────────────────────────────────── -->
      <!-- <section class="page-hero page-hero--book" aria-labelledby="book-page-hero-heading">
      ...
      <section class="book-section page-section book-section--page-top" aria-labelledby="book-page-heading">
...
None of this is science fiction. It is the documented trajectory of what is already moving.
              ...
              <div class="book-cta-row">
                ...
                >Get on Amazon</a>
                <a href="{{ url('/book-details') }}" class="btn-secondary">Read the Book Before the World Catches Up</a>
              </div>
            </div>
          </div>
        </div>
...
The world in 2050 is not a prediction. It is a map, written by someone who has spent years inside the territory.
      ...
      <!-- <section class="page-section bg-surface-2 page-cta-strip" aria-labelledby="book-cta-heading">
        <div class="page-cta-inner reveal-up">
          ...
          <div class="page-cta-actions">
            ...
            <a href="{{ url('/contact-us') }}" class="btn-secondary">Contact Us</a>
          </div>
        </div>
      </section> -->
      ...
      <a
        href="{{ $amazonBookUrl }}"
        class="book-amazon-sticky btn-primary"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Get World in 2050 on Amazon (opens in new tab)"
      >Get on Amazon</a>
