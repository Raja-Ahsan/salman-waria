        ...
        <div class="container">
          <div class="split-2 align-center">
            <div class="media-frame reveal-left">
              <img
              src="<?php echo $sw_h_base; ?>/images/salaman-waria-about-image.png"
                alt="Salman Waria"
                width="600"
                height="560"
                loading="lazy"
            ...
            <div class="stack stack-lg reveal-right">
              <div class="page-block-header" style="margin-bottom: 0;">
                ...
                <h2 class="section-title" id="about-bio-heading"><span class="gold-text">Who I am</span></h2>
              </div>
              <p class="text-prose">
             <strong>Salman</strong> is undoubtedly a visionary. He started his first digital venture in Dubai at 19, and that early bet shaped the framework he still operates from: real markets, real capital ,real results
        ...
        <div class="container">
          <div class="split-2 align-center">
            ...
            <div class="media-frame reveal-right">
              <img
                src="<?php echo $sw_h_base; ?>/images/salman-waria-03.jpeg"
